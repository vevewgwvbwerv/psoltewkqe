                ...
                if handPart and handPart.Parent then
                    ...
                    if copyPart then
                        local success, errorMsg = pcall(function()
                            ...
                            -- 📍 СМЕЩЕНИЕ КОПИИ К ОРИГИНАЛЬНОМУ ПИТОМЦУ (А НЕ В РУКУ!)
                            if originalModel and originalModel.PrimaryPart then
                                ...
                                -- Заменяем позицию на смещенную
                                scaledCFrame = CFrame.new(targetPos) * (scaledCFrame - scaledCFrame.Position)
                            end
