...
local function deepCopyModel(originalModel)
    ...
    if originalModel.PrimaryPart and copy.PrimaryPart then
        ...
        -- 🚨 ЭКСТРЕМАЛЬНОЕ ИСПРАВЛЕНИЕ: ТОЧНАЯ ПОЗИЦИЯ КАК У СЕРОГО КВАДРАТА!
        -- Пользователь сказал: когда был серый квадрат, питомец был на правильном уровне
        local groundY = originalPos.Y  -- ТОЧНО ТА ЖЕ высота что у оригинала (как серый квадрат)
        
        -- НЕТ ДОПОЛНИТЕЛЬНЫХ ПОДЪЕМОВ! Используем точную позицию оригинала
        print("📍 Устанавливаем копию на ТОЧНЫЙ уровень оригинала Y =", groundY)
