...
local function openDetailNotebook(analysis)
    ...
    detailNotebook.Size = UDim2.new(0.8, 0, 0.85, 0)  -- Адаптивный размер
    detailNotebook.Position = UDim2.new(0.1, 0, 0.075, 0)  -- Центрирование
    ...
    local uuidLabel = Instance.new("TextLabel")
    uuidLabel.Name = "UUIDLabel"
    uuidLabel.Size = UDim2.new(1, -20, 0, 20)
    uuidLabel.Position = UDim2.new(0, 10, 0, 5)
    uuidLabel.BackgroundTransparency = 1
    uuidLabel.Text = "🔍 UUID: " .. analysis.uuid
    uuidLabel.TextColor3 = Color3.fromRGB(255, 255, 255)
    uuidLabel.TextSize = 12
    uuidLabel.Font = Enum.Font.SourceSansBold
    uuidLabel.TextXAlignment = Enum.TextXAlignment.Left
    uuidLabel.TextScaled = true
    uuidLabel.ZIndex = 11
    uuidLabel.Parent = contentFrame
...
local function createMainGUI()
    ...
    mainFrame.Size = UDim2.new(0.9, 0, 0.8, 0)  -- Адаптивный размер
    mainFrame.Position = UDim2.new(0.05, 0, 0.1, 0)  -- Центрирование
