...
local function main()
    ...
    -- ДОПОЛНИТЕЛЬНО: Прямое копирование анимаций от оригинала к копии
    ...
    if endlessConnection then
        ...
        print("✅ Анимации переданы от оригинала")
        print("🎭 Копия повторяет движения оригинального питомца!")
        print("🔥 Копия всегда в движении - как живая!")
    else
        print("⚠️ Основная анимация не запустилась, но прямое копирование работает")
        print("💡 Копия получает анимации напрямую от оригинала")
    end
end
