    ...
    spawn(function()
        ...
        if shovel.Parent == character then
            ...
            if handle and rightHand then
                ...
                -- ПРОСТОЕ СТАНДАРТНОЕ КРЕПЛЕНИЕ - БЕЗ КОПИРОВАНИЯ!
                ...
                print("📍 ПРИМЕНЕНО ПРОСТОЕ стандартное крепление!")
                print("📍 C0: CFrame.new(0, -1, -0.5)")
                print("📍 C1: CFrame.new(0, 0, 0)")
                print("✅ Никаких копирований - только проверенное стандартное крепление!")
